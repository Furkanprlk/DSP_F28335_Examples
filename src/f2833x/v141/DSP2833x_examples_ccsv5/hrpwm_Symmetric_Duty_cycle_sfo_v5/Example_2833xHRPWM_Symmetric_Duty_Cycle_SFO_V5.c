...
//!
//! This example modifies the MEP control registers to show symmetric edge displacement
...
//====================================================================
   HRPWM_Config(50);	    // ePWMx target, 5 MHz PWM (150MHz SYSCLKOUT)/3.33 MHz PWM (100MHz SYSCLKOUT)
