%//#############################################################################
%//! \file /2837x_CFFT/matlab/CFFTforC28xNew.m
%//!
%//! \brief  MATLAB code for the Complex Fast Fourier Transform(unaligned)
%//! with scaled magnitude
%//! \author C2000
%//! 
%//! This matlab code is reference code for debugging FPU library
%//! function CFFT_f32 and example project 
%//! 28xxx_CFFT_Unaligned_ScaledMagnitude. The structure 
