...
; compute 3P3Z filter
	MOV		AR0,#12
	MOVL	XT, *+XAR5[AR0]			; XT  = e(n-3)
	QMPYL	P, XT, *XAR4++			; P   = e(n-3)Q30*B3{Q24} = I8Q22

	MOV		AR0,#10					;
	MOVDL	XT, *+XAR5[AR0]			; XT  = e(n-2), e(n-3) = e(n-2)
	QMPYAL	P, XT, *XAR4++ 			; P   = e(n-2)Q30*B2{Q24} = Q24, ACC=e(n-3)*B3

	MOV		AR0,#8
	MOVDL	XT, *+XAR5[AR0]	 		; XT  = e(n-1), e(n-2) = e(n-1)
	QMPYAL	P, XT, *XAR4++ 			; P   = e(n-1)Q30*B1{Q24}= Q24, ACC = e(n-3)*B3 + e(n-2)*B2

	MOVDL	XT,*+XAR5[6]			; XT  = e(n),   e(n-1) = e(n)
	QMPYAL	P, XT, *XAR4++			; P   = e(n)Q30*B0{Q24}  = Q24, ACC = e(n-3)*B3 + e(n-2)*B2 + e(n-1)*B1

	MOVL	XT,*+XAR5[4] 			; XT  = u(n-3)
	QMPYAL	P, XT, *XAR4++ 			; P   = u(n-3)*A3, ACC = e(n-3)B3 +e(n-2)*B2 + e(n-1)*B1 + e(n)*B0
