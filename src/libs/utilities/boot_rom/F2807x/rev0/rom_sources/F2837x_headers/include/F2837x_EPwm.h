...
struct VCAPCTL_BITS {                                 // bit descriptions
...
struct VCNTCFG_BITS {                                 // bit descriptions
...
struct HRCNFG_BITS {                                  // bit descriptions
    ...
    Uint16  rsvd1:1;                                  // 13:13 Reserved 
    Uint16  LINESEL:2;                                // 15:14 Delay Line Selection bits 
};
...
struct HRPWR_BITS {                                   // bit descriptions
    ...
    Uint16  CALSTART:1;                               // 2 Calibration Start/Stop 
    Uint16  CNTSEL:1;                                 // 3 Counter Select Bit 
    Uint16  CALSTS:1;                                 // 4 Calibration Status Bit 
    Uint16  TESTSEL:1;                                // 5 Test Mode (Lump Delay) Select Bit 
    Uint16  CALSEL:4;                                 // 9:6 ePWM Delay Line Selection for Calibration 
...
struct HRCNFG2_BITS {                                 // bit descriptions
    ...
    Uint16  DELLOADFRC:1;                             // 14 Delay Line Load Software Force 
    Uint16  NOBYPASS:1;                               // 15 No Bypass Delay Line Update 
};
...
struct HRPCTL_BITS {                                  // bit descriptions
    ...
    Uint16  HRPSYNCE:1;                               // 3 High Resolution Period Sync Enable 
...
struct TRREM_BITS {                                   // bit descriptions
...
struct EPWMREV_BITS {                                 // bit descriptions
...
struct HRPWMREV_BITS {                                // bit descriptions
    Uint16  REV:8;                                    // 7:0 HRPWM Silicon Revision bits 
    Uint16  TYPE:8;                                   // 15:8 HRPWM Type Bits 
};

union HRPWMREV_REG {
    Uint16  all;  
    struct  HRPWMREV_BITS  bit;  
};
...
struct DBREDHR_BITS {                                 // bit descriptions
    ...
    Uint16  DBREDHR_DELAY:7;                          // 7:1 DBREDHR Delay (TI Test) 
    Uint16  rsvd2:1;                                  // 8:8 Reserved 
...
struct DBFEDHR_BITS {                                 // bit descriptions
    Uint16  rsvd1:1;                                  // 0:0 Reserved 
    Uint16  DBFEDHR_DELAY:7;                          // 7:1 DBFEDHR Delay (TI Test) 
    Uint16  rsvd2:1;                                  // 8:8 Reserved 
...
struct TBPRDHRB_BITS {                                // bit descriptions
    Uint16  TBPRDHRB_DELAY:8;                         // 7:0 TBPRDHRB Delay (TI Test) 
    Uint16  TBPRDHRB:8;                               // 15:8 TBPRDHR Calc (2) Results for EPWMxB Eqns 
};

union TBPRDHRB_REG {
    Uint16  all;  
    struct  TBPRDHRB_BITS  bit;  
};
...
struct EPWM_REGS {
    ...
    Uint16                      HRCAL;                // HRPWM Calibration Register 
    Uint16                      HRPRD;                // HRPWM Period Register 
    Uint16                      HRCNT0;               // HRPWM Counter 0 Register 
    Uint16                      HRCNT1;               // HRPWM Counter 1 Register 
    ...
    union   HRPWMREV_REG        HRPWMREV;             // High Resolution Revision Register 
    ...
    union   TBPRDHRB_REG        TBPRDHRB;             // Calculation Result for EPWMxB 
    Uint16                      rsvd16[5];            // Reserved 
