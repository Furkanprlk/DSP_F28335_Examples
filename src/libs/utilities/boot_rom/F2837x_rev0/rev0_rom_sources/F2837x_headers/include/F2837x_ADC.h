...
struct ADCINTFLG_BITS {                               // bit descriptions
    Uint16  ADCINT1:1;                                // 0 ADC Interrupt Flag 
    Uint16  ADCINT2:1;                                // 1 ADC Interrupt Flag 
    Uint16  ADCINT3:1;                                // 2 ADC Interrupt Flag 
    Uint16  ADCINT4:1;                                // 3 ADC Interrupt Flag 
    Uint16  ADCINT5:1;                                // 4 ADC Interrupt Flag 
    Uint16  ADCINT6:1;                                // 5 ADC Interrupt Flag 
    Uint16  ADCINT7:1;                                // 6 ADC Interrupt Flag 
    Uint16  ADCINT8:1;                                // 7 ADC Interrupt Flag 
    Uint16  ADCINT9:1;                                // 8 ADC Interrupt Flag 
...
struct ADCINTFLGCLR_BITS {                            // bit descriptions
    Uint16  ADCINT1:1;                                // 0 ADC Interrupt Flag Clear 
    Uint16  ADCINT2:1;                                // 1 ADC Interrupt Flag Clear 
    Uint16  ADCINT3:1;                                // 2 ADC Interrupt Flag Clear 
    Uint16  ADCINT4:1;                                // 3 ADC Interrupt Flag Clear 
    Uint16  ADCINT5:1;                                // 4 ADC Interrupt Flag Clear 
    Uint16  ADCINT6:1;                                // 5 ADC Interrupt Flag Clear 
    Uint16  ADCINT7:1;                                // 6 ADC Interrupt Flag Clear 
    Uint16  ADCINT8:1;                                // 7 ADC Interrupt Flag Clear 
    Uint16  ADCINT9:1;                                // 8 ADC Interrupt Flag Clear 
    Uint16  rsvd1:7;                                  // 15:9 Reserved 
};
...
struct ADCINTOVF_BITS {                               // bit descriptions
    Uint16  ADCINT1:1;                                // 0 ADC Interrupt Overflow Flags 
    Uint16  ADCINT2:1;                                // 1 ADC Interrupt Overflow Flags 
    Uint16  ADCINT3:1;                                // 2 ADC Interrupt Overflow Flags 
    Uint16  ADCINT4:1;                                // 3 ADC Interrupt Overflow Flags 
    Uint16  ADCINT5:1;                                // 4 ADC Interrupt Overflow Flags 
    Uint16  ADCINT6:1;                                // 5 ADC Interrupt Overflow Flags 
    Uint16  ADCINT7:1;                                // 6 ADC Interrupt Overflow Flags 
    Uint16  ADCINT8:1;                                // 7 ADC Interrupt Overflow Flags 
    Uint16  ADCINT9:1;                                // 8 ADC Interrupt Overflow Flags 
    Uint16  rsvd1:7;                                  // 15:9 Reserved 
};
...
struct ADCINTOVFCLR_BITS {                            // bit descriptions
    Uint16  ADCINT1:1;                                // 0 ADC Interrupt Overflow Clear Bits 
    Uint16  ADCINT2:1;                                // 1 ADC Interrupt Overflow Clear Bits 
    Uint16  ADCINT3:1;                                // 2 ADC Interrupt Overflow Clear Bits 
    Uint16  ADCINT4:1;                                // 3 ADC Interrupt Overflow Clear Bits 
    Uint16  ADCINT5:1;                                // 4 ADC Interrupt Overflow Clear Bits 
    Uint16  ADCINT6:1;                                // 5 ADC Interrupt Overflow Clear Bits 
    Uint16  ADCINT7:1;                                // 6 ADC Interrupt Overflow Clear Bits 
    Uint16  ADCINT8:1;                                // 7 ADC Interrupt Overflow Clear Bits 
    Uint16  ADCINT9:1;                                // 8 ADC Interrupt Overflow Clear Bits 
    Uint16  rsvd1:7;                                  // 15:9 Reserved 
};
...
struct ADCOSDETECT_BITS {                             // bit descriptions
...
struct ADCPPB1TRIPHI_BITS {                           // bit descriptions
    Uint32  LIMITHI:17;                               // 16:0 ADC Post Processing Block Trip High Limit 
...
struct ADCPPB1TRIPLO_BITS {                           // bit descriptions
    Uint32  LIMITLO:17;                               // 16:0 ADC Post Processing Block Trip Low Limit 
...
struct ADCINLTRIMCTL_BITS {                           // bit descriptions
    Uint16  CALIBMODE:1;                              // 0 ADC Linearity Calibration Mode 
    Uint16  CALIBSTEP:5;                              // 5:1 ADC Linearity Calibration Step 
    Uint16  rsvd1:10;                                 // 15:6 Reserved 
    Uint16  KEY:16;                                   // 31:16 ADC Linearity Trim Control Write Key 
};

union ADCINLTRIMCTL_REG {
    Uint32  all;  
    struct  ADCINLTRIMCTL_BITS  bit;  
};

struct ADCPPB1RESULT_REG {                            // bit descriptions
    Uint32  PPBRESULT:17;                             // 16:0 ADC Post Processing Block Result 
...
struct ADC_REGS {
    ...
    Uint16                         ADCCONFIG;         // ADC Config Register 
    ...
    Uint16                         ADCPPB1OFFCAL;     // ADC PPB1 Offset Calibration Register 
    ...
    Uint16                         ADCPPB2OFFCAL;     // ADC PPB2 Offset Calibration Register 
    ...
    Uint16                         ADCPPB3OFFCAL;     // ADC PPB3 Offset Calibration Register 
    ...
    Uint16                         ADCPPB4OFFCAL;     // ADC PPB4 Offset Calibration Register 
    ...
    union   ADCINLTRIMCTL_REG      ADCINLTRIMCTL;     // ADC Linearity Trim Control Register 
};
